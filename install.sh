...
packages=(zsh xf86-video-intel i3-gaps i3blocks i3lock i3status dmenu rofi picom reflector zsh-autosuggestions zsh-syntax-highlighting firefox code bluez bluez-utils pulseaudio-bluetooth zsh-theme-powerlevel10k mupdf nodejs yarn rustup rust-analyzer-bin feh lxappearance telegram-desktop qbittorrent tree alacritty)
...
sym=( .Xresources .zshrc .fonts .config/{i3,polybar,rofi,mpv,nvim,alacritty} .p10k.zsh )
